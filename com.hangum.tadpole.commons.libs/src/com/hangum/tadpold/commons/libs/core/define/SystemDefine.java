...
public class SystemDefine {
	...
	public static final String MAJOR_VERSION = "1.1.3(Living)";
	public static final String SUB_VERSION = "Build" + "(04)";	
	public static final String RELEASE_DATE = "2013.11.12";
