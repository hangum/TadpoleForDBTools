 ...
 * <ul>
 *   <li>{@link com.hangum.tadpole.rdb.model.impl.UserCommentImpl#getComment <em>Comment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UserCommentImpl extends EObjectImpl implements UserComment {
	...
	protected EClass eStaticClass() {
		return RdbPackage.Literals.USER_COMMENT;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RdbPackage.USER_COMMENT__COMMENT, oldComment, comment));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RdbPackage.USER_COMMENT__COMMENT:
				return getComment();
		}
