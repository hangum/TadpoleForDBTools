 ...
 * <ul>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getColumns <em>Columns
 * </em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getDb <em>Db</em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getName <em>Name</em>}
 * </li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getConstraints <em>
 * Constraints</em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getIncomingLinks <em>
 * Incoming Links</em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getOutgoingLinks <em>
 * Outgoing Links</em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getLogicalName <em>
 * Logical Name</em>}</li>
 * <li>{@link com.hangum.tadpole.rdb.model.impl.TableImpl#getComment <em>Comment
 * </em>}</li>
 * <li>
 * {@link com.hangum.tadpole.rdb.model.impl.TableImpl#getUserCommentReference
...
public class TableImpl extends EObjectImpl implements Table {
	 ...
	 */
	public DB getDb() {
		if (eContainerFeatureID() != RdbPackage.TABLE__DB)
			return null;
	...
	public UserComment getUserCommentReference() {
		if (userCommentReference != null && userCommentReference.eIsProxy()) {
			...
			if (userCommentReference != oldUserCommentReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, RdbPackage.TABLE__USER_COMMENT_REFERENCE, oldUserCommentReference,
