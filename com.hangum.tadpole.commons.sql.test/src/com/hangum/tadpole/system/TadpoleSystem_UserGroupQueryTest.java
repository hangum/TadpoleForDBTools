...
public class TadpoleSystem_UserGroupQueryTest extends TestCase {
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserGroupQuery#newUserGroup(String)
	 * 신규 유저그룹 등록 테스트}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserGroupQuery#isUserGroup(String)
	 * 유저그룹 존재}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserGroupQuery#getGroup()
	 * 유저그룹 리스트 테스트}
	 */
