...
/**
 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource 시스템 리소스
 * 테스트}
 * 
 * @author hangum
 * 
...
public class TadpoleSystem_UserDBResourceTest extends TestCase {
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource#saveResource(UserDBDAO, com.hangum.tadpole.define.PublicTadpoleDefine.RESOURCE_TYPE, String, String)
	 * 시스템 리소스 저장 테스트}
	 */
	public void testSaveResource() {
		// try {
		// UserDBResourceDAO userDBResource =
		// TadpoleSystem_UserDBResource.saveResource(userDb.getUser_seq(),
		// userDb, PublicTadpoleDefine.RESOURCE_TYPE.SQL, "junit",
		// "junit content");
		// } catch (Exception e) {
		// e.printStackTrace();
		// fail("SaveResouece");
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource#updateResource(UserDBResourceDAO, String)
	 * 시스템 리소스 수정 테스트}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource#userDbErdTree(UserDBDAO)
	 * 시스템 리소스 테스트}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource#userDBResourceDuplication(com.hangum.tadpole.define.PublicTadpoleDefine.RESOURCE_TYPE, int, int, String)
	 * 시스템 리소스 중복 테스트}
	 */
	public void testUserDBResourceDuplication() {
		try {
			boolean bool = TadpoleSystem_UserDBResource.userDBResourceDuplication(PublicTadpoleDefine.RESOURCE_TYPE.SQL, userDb.getUser_seq(), userDb.getSeq(),
					"junit");
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBResource#delete(UserDBResourceDAO)
	 * 시스템 리소스 삭제 테스트}
	 */
	public void testGetResourceData() {
		try {
			...
			if (!str.equals("junit update"))
				fail("getResource exception");
