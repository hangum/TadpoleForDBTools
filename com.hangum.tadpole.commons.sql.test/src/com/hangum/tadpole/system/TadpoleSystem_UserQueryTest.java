...
public class TadpoleSystem_UserQueryTest extends TestCase {
	...
	//
	// public static UserDAO defaultUserDAO = new UserDAO(email, passwd, name,
	// null);
	//
	//
	// @Override
	...
	// if(!isGroupExist) {
	// groupSeq =
	// TadpoleSystem_UserGroupQuery.newUserGroup(TadpoleSystem_UserGroupQueryTest.groupName);
	// }
	//
	// } catch (Exception e) {
	...
	// // /**
	// // * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#deleteUser(UserDAO)
	// 유저삭제}
	// // */
	...
	//
	// /**
	// * {@link com.hangum.tadpole.system.TadpoleSystem_UserQuery#newUser(int,
	// String, String, String, USER_TYPE) 시스템엔진디비 유저 입력}
	// */
	// public void testNewUserIntStringStringStringUSER_TYPE() {
	//
	// try {
	// defaultUserDAO = TadpoleSystem_UserQuery.newUser(email, passwd, name,
	// userType);
	//
	...
	// /**
	// * {@link com.hangum.tadpole.system.TadpoleSystem_UserQuery#newUser(int,
	// String, String, String, String, String) 유저 중복입력 테스트}
	// */
	...
	// /**
	// * {@link com.hangum.tadpole.system.TadpoleSystem_UserQuery#newUser(int,
	// String, String, String, String) 유저 중복입력 테스트}
	// */
	// public void testNewUserIntStringStringStringString() {
	// try {
	// defaultUserDAO = TadpoleSystem_UserQuery.newUser(groupSeq, email, passwd,
	...
	// /**
	// * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#isDuplication(String)
	// 유저 중복 테스트}
	// */
	...
	//
	// /**
	// * {@link com.hangum.tadpole.system.TadpoleSystem_UserQuery#login(String,
	// String) 로그인테스트}
	// */
	...
	//
	// /**
	// * {@link com.hangum.tadpole.system.TadpoleSystem_UserQuery#loginUserCount
	// admin user가 한명이라면 로그인 화면에서 기본 유저로 설정 테스트}
	// */
	...
	// /**
	// * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#getUserListPermission
	// 유저 카운트}
	// */
	// public void testGetUserListPermission() {
	// try {
	// List<UserGroupAUserDAO> userList =
	// TadpoleSystem_UserQuery.getUserListPermission();
	...
	// /**
	// * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#getUserListPermission(int)
	// 그룹 유저 카운트 테스트}
	// */
	// public void testGetUserListPermissionInt() {
	// try {
	// List<UserGroupAUserDAO> userList =
	// TadpoleSystem_UserQuery.getUserListPermission(groupSeq);
	// assertEquals(userList.size() == 0, false);
	// } catch (Exception e) {
	// e.printStackTrace();
	// fail("getUserListPermission test fail");
	...
	// /**
	// * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#updateUserData(UserDAO)
	// 업데이트 유저 테스트}
	// */
	...
	// /**
	// * {@link
	// com.hangum.tadpole.system.TadpoleSystem_UserQuery#updateUserPassword(UserDAO)
	// 업데이트 유저 패스워드 테스트}
	// */
