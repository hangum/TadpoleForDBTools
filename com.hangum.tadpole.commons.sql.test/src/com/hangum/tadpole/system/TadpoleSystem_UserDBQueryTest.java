...
/**
 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBQuery 시스템 UserDB
 * 테스트}
 * 
 * @author hangum
 * 
...
public class TadpoleSystem_UserDBQueryTest extends TestCase {
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBQuery#newUserDB(UserDBDAO)
	 * UserDB등록 테스트}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBQuery#getUserDB(int)
	 * 세션의 데이터를 가져오기위한 코드인데 어떻게 테스트 하지?}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBQuery#getSpecificUserDB(int)
	 * 세션의 데이터를 가져오기위한 코드인데 어떻게 테스트 하지?}
	 */
	...
	/**
	 * {@link com.hangum.tadpole.sql.system.TadpoleSystem_UserDBQuery#removeUserDB(int)
	 * userdb 삭제.}
	 */
