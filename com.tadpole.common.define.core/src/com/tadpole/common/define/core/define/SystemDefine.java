...
public class SystemDefine {
	...
	public static final String DBHUB_MAJOR_VERSION = "2.1.0";
	public static final String DBHUB_SUB_VERSION = "Build (R0)";
	public static final String DBHUB_RELEASE_DATE = "2020.05.27";
