...
public class UserCommentImpl extends EObjectImpl implements UserComment {
	...
	protected EClass eStaticClass() {
		return MongodbPackage.Literals.USER_COMMENT;
	}
	...
	public void setComment(String newComment) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MongodbPackage.USER_COMMENT__COMMENT, oldComment, comment));
	}
