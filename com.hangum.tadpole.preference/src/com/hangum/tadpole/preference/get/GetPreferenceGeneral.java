...
public class GetPreferenceGeneral {
	...
	public static String getExportDelimit() {
		...
		if (null == userInfo)
			return PreferenceDefine.EXPORT_DILIMITER_VALUE;
		else if ("".equals(userInfo.getValue0()))
			return PreferenceDefine.EXPORT_DILIMITER_VALUE;
	...
	public static String getDefaultHomePage() {
		...
		if (null == userInfo)
			return PreferenceDefine.DEFAULT_HOME_PAGE_VALUE;
		else if ("".equals(userInfo.getValue0()))
			return PreferenceDefine.DEFAULT_HOME_PAGE_VALUE;
	...
	public static String getDefaultHomePageUse() {
		...
		if (null == userInfo)
			return PreferenceDefine.DEFAULT_HOME_PAGE_USE_VALUE;
		else if ("".equals(userInfo.getValue0()))
			return PreferenceDefine.DEFAULT_HOME_PAGE_USE_VALUE;
