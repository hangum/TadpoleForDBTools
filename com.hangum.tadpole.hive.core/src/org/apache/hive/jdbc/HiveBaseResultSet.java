...
public abstract class HiveBaseResultSet implements ResultSet {
	...
	private Object getColumnValue(int columnIndex) throws SQLException {
		...
		/*
		 * switch (tColumnValue.getSetField()) { case BOOL_VAL: return
		 * getBooleanValue(tColumnValue.getBoolVal()); case BYTE_VAL: return
		 * getByteValue(tColumnValue.getByteVal()); case I16_VAL: return
		 * getShortValue(tColumnValue.getI16Val()); case I32_VAL: return
		 * getIntegerValue(tColumnValue.getI32Val()); case I64_VAL: return
		 * getLongValue(tColumnValue.getI64Val()); case DOUBLE_VAL: return
		 * getDoubleValue(tColumnValue.getDoubleVal()); case STRING_VAL: return
		 * getStringValue(tColumnValue.getStringVal()); default: throw new
		 * SQLException("Unrecognized column type:" +
		 * tColumnValue.getSetField()); }
		 */
	}
