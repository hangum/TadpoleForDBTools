...
public class HiveDatabaseMetaData implements java.sql.DatabaseMetaData {
   ...
   */
	...
	public ResultSet getColumns(String catalog, final String schemaPattern, final String tableNamePattern, final String columnNamePattern) throws SQLException {
		...
		try {
			...
			return new HiveMetaDataResultSet<JdbcColumn>(Arrays.asList("TABLE_CAT", "TABLE_SCHEM", "TABLE_NAME", "COLUMN_NAME", "DATA_TYPE", "TYPE_NAME",
					"COLUMN_SIZE", "BUFFER_LENGTH", "DECIMAL_DIGITS", "NUM_PREC_RADIX", "NULLABLE", "REMARKS", "COLUMN_DEF", "SQL_DATA_TYPE",
					"SQL_DATETIME_SUB", "CHAR_OCTET_LENGTH", "ORDINAL_POSITION", "IS_NULLABLE", "SCOPE_CATLOG", "SCOPE_SCHEMA", "SCOPE_TABLE",
					"SOURCE_DATA_TYPE"), Arrays.asList("STRING", "STRING", "STRING", "STRING", "INT", "STRING", "INT", "INT", "INT", "INT", "INT", "STRING",
					"STRING", "INT", "INT", "INT", "INT", "STRING", "STRING", "STRING", "STRING", "INT"), columns) {
	...
	public ResultSet getTableTypes() throws SQLException {
		...
		ResultSet result = new HiveMetaDataResultSet<TableType>(Arrays.asList("TABLE_TYPE"), Arrays.asList("STRING"), new ArrayList<TableType>(
				Arrays.asList(tt))) {
			private int cnt = 0;
	...
	public ResultSet getTables(String catalog, String schemaPattern, String tableNamePattern, String[] types) throws SQLException {
		...
		ResultSet result = new HiveMetaDataResultSet<JdbcTable>(Arrays.asList("TABLE_CAT", "TABLE_SCHEM", "TABLE_NAME", "TABLE_TYPE", "REMARKS"),
				Arrays.asList("STRING", "STRING", "STRING", "STRING", "STRING"), resultTables) {
			private int cnt = 0;
			...
			public boolean next() throws SQLException {
				if (cnt < data.size()) {
					...
					a.add(table.getTableCatalog()); // TABLE_CAT String => table
													// catalog (may be null)
					a.add(null); // TABLE_SCHEM String => table schema (may be
									// null)
					a.add(table.getTableName()); // TABLE_NAME String => table
													// name
					try {
					...
					a.add(table.getComment()); // REMARKS String => explanatory
