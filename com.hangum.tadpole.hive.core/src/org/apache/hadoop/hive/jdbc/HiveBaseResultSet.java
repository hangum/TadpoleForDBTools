...
/**
 * Data independed base class which implements the common part of all hive
 * resultsets.
 */
public abstract class HiveBaseResultSet implements ResultSet {
	...
	public BigDecimal getBigDecimal(int columnIndex) throws SQLException {
		...
		throw new SQLException("Cannot convert column " + columnIndex + " to BigDecimal. Found data of type: " + obj.getClass() + ", value: " + obj.toString());
	}
