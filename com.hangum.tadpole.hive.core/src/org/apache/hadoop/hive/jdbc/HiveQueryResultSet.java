...
public class HiveQueryResultSet extends HiveBaseResultSet {
	...
	// LogFactory.getLog(HiveQueryResultSet.class);
	...
	public boolean next() throws SQLException {
		...
		try {
			...
			if (e.getErrorCode() == 0) { // error code == 0 means reached the
											// EOF
				return false;
			} else {
	 ...
	 * 3.0 (see JDBC 3.0 Specification, Table B-3: Mapping from JDBC Types to
	 * Java Object Types).
	 * 
	 * This method is kept consistent with
	 * {@link HiveResultSetMetaData#hiveTypeToSqlType}.
	 */
