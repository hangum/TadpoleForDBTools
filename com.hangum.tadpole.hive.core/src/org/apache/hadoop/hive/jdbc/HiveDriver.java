...
public class HiveDriver implements Driver {
   ...
   */
	 ...
	 * 
	 * @return The Major version number of the driver. -1 if it cannot be
	 *         determined from the manifest.mf file.
	 */
	 ...
	 * 
	 * @return The Minor version number of the driver. -1 if it cannot be
	 *         determined from the manifest.mf file.
	 */
