...
/**
 * create collection (ref1, ref2) ref1 and ref2- reference collection
 * 
 * 
...
public class MongoTestReferenceCollection {
	...
	public static void createRef1Collection(DB db, Object objId) {
		...
		// DBObject dbObjRef2 = (DBObject)
		// JSON.parse("{'ref1_id': 50f9437cf023f820730a3b42,  {'names': {'First': 'Gonza', 'Last': 'Vieira'}}}");
