...
public class MapReduceEditor extends EditorPart {
	...
	public void createPartControl(Composite parent) {
		...
		textMap = new TadpoleEditorWidget(grpMap, SWT.BORDER, "", strAssist);
		...
		textReduce = new TadpoleEditorWidget(grpReduce, SWT.BORDER, "", strAssist);
		...
		textFinalize = new TadpoleEditorWidget(grpFinalize, SWT.BORDER, "", strAssist);
		...
		textQuery = new TadpoleEditorWidget(grpInput, SWT.BORDER, "", strAssist);
		...
		textSort = new TadpoleEditorWidget(grpInput, SWT.BORDER, "", strAssist);
