...
public class CollectionInformationComposite extends Composite {
	...
	private void createTableColumn() {
		String[] columnName = {
				"Name", "Rows", "Size", "Storage", "Index", "Last Extent Size", "AvgObj", "Padding"}; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$ //$NON-NLS-5$ //$NON-NLS-6$ //$NON-NLS-7$ //$NON-NLS-8$
		int[] columnSize = {
				200,
				100,
				100,
...
class MongoInfoLabelProvider extends LabelProvider implements ITableLabelProvider {
	...
	public String getColumnText(Object element, int columnIndex) {
		if (element instanceof MongoDBCollectionInfoDTO) {
			...
			case 5:
				return NumberFormatUtils.commaFormat(info.getLastExtentSize());
			case 6:
