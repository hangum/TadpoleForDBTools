 ...
 * 
 * - collection list(Name, Count, Size, Storage, Index, AvgObj, Padding) - field
 * list
 * 
 * summary info
 * 
...
public class MongoDBInfosEditor extends EditorPart {
	...
	public void createPartControl(Composite parent) {
		...
		else if (defaultPage == PAGES.COLLECTION_SUMMERY)
			tabFolder.setSelection(1);
		else if (defaultPage == PAGES.DB_LOCKS)
			tabFolder.setSelection(2);
		else if (defaultPage == PAGES.REPLACA_SET)
