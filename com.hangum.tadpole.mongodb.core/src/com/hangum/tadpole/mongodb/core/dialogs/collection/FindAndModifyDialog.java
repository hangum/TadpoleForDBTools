...
public class FindAndModifyDialog extends Dialog {
	 ...
	 */
	private static final Logger logger = Logger.getLogger(FindAndModifyDialog.class);
	...
	protected Control createDialogArea(Composite parent) {
		...
		compositeBody.setWeights(new int[] {
				40,
				20,
				20,
				20
	...
	protected void okPressed() {
		...
		try {
			DBObject retDBObj = MongoDBQuery.findAndModify(userDB, collName, objQuery, objSort, objFields, btnRemove.getSelection(), objUpdate,
					btnReturnNew.getSelection(), btnUpsert.getSelection());
			if (null != retDBObj) {
