...
public class MongoDBQuery {
	 ...
	 * 
	 * System
	 * collections(http://docs.mongodb.org/manual/reference/system-collections
	 * /)을 제외한 collection list를 리턴합니다.
	 * 
	 * 
	 * @param userDB
	 * @return
	 ...
	 * @throws Exception
	 */
	public static DBObject findAndModify(UserDBDAO userDB, String collName, DBObject objQuery, DBObject objSort, DBObject objFields, boolean isRemove,
			DBObject objUpdate, boolean isReturnNew, boolean isUpsert) throws Exception {
	...
	// * @throws Exception
	// */
	// public static String explain(UserDBDAO userDB, String colName, String
	// jsonStr) throws Exception {
	// DBCollection collection = findCollection(userDB, colName);
	// DBObject dbObject = (DBObject) JSON.parse(jsonStr);
	//
	...
	// * @throws Exception
	// */
	// public static DBCursor findQuery(UserDBDAO userDB, String colName, String
	// jsonStr) throws Exception {
	// DBCollection collection = findCollection(userDB, colName);
	// DBObject dbObject = (DBObject) JSON.parse(jsonStr);
	//
	...
	public static void updateDocument(UserDBDAO userDB, String colName, DBObject dBObject, String key, String value) throws Exception {
		...
		// BasicDBObject().append("allPlans.0.cursor", "t2est"));
