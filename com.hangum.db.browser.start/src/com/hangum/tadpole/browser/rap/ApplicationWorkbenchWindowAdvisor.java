...
import com.hangum.tadpole.browser.rap.dialog.login.LoginDialog;
...
public class ApplicationWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {
    ...
    public void preWindowOpen() {
        ...
        configurer.setTitle("Tadpole for DB Tools 0.0.8 SR6"); //$NON-NLS-1$
    	...
    	try {
			...
			ExceptionDetailsErrorDialog.openError(null, "Error", com.hangum.tadpole.browser.rap.Messages.ApplicationWorkbenchWindowAdvisor_2, errStatus); //$NON-NLS-1$
