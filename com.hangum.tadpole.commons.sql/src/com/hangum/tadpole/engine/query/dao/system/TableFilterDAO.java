 ...
 *
 */
public class TableFilterDAO {
	int seq;
	int db_seq;
	String table_name;
	String description;
	String table_lock = PublicTadpoleDefine.YES_NO.NO.name();
	String column_names;
	...
	/**
	 * @param table_lock the table_lock to set
	 */
