...
public class MySQLDMLTemplate extends AbstractDMLTemplate {
	...
	/** view -mysql */
	public static final String  TMP_CREATE_VIEW_STMT = "CREATE VIEW {#schema#}.view_name AS " + PublicTadpoleDefine.LINE_SEPARATOR + 
	...
	/** constraints */
	public static final String  TMP_CREATE_CONSTRAINTS_STMT = "ALTER TABLE {#schema#}.sample_table ADD COLUMN `author` int(10) unsigned NOT NULL ; "+ PublicTadpoleDefine.LINE_SEPARATOR 
                                                            + "ALTER TABLE {#schema#}.sample_table ADD INDEX (author) ; "+ PublicTadpoleDefine.LINE_SEPARATOR
                                                            + "ALTER TABLE {#schema#}.sample_table ADD FOREIGN KEY (author) REFERENCES `users` (`id`) ;  "+ PublicTadpoleDefine.LINE_SEPARATOR;
	
	/** procedure */
	public static final String  TMP_CREATE_PROCEDURE_STMT = "CREATE PROCEDURE {#schema#}.simpleproc (OUT param1 INT) " + PublicTadpoleDefine.LINE_SEPARATOR +
