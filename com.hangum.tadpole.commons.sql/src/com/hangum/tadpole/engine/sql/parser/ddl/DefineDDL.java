...
public enum DefineDDL {
	...
	TRIGGER_CREATE("CREATE\\s+TRIGGER\\s+([A-Z0-9_\\.\"'`]+)", QUERY_DDL_TYPE.PACKAGE, QUERY_DDL_STATUS.CREATE),
	TRIGGER_CREATE_REPLACE("TRIGGER\\s+OR\\s+REPLACE\\s+PACKAGE\\s+([A-Z0-9_\\.\"'`]+)", QUERY_DDL_TYPE.PACKAGE, QUERY_DDL_STATUS.CREATE),
	TRIGGER_ALTER("ALTER\\s+TRIGGER\\s+([A-Z0-9_\\.\"'`]+)", QUERY_DDL_TYPE.PACKAGE, QUERY_DDL_STATUS.ALTER),
	TRIGGER_DROP("DROP\\s+TRIGGER\\s+([A-Z0-9_\\.\"'`]+)", QUERY_DDL_TYPE.PACKAGE, QUERY_DDL_STATUS.DROP)
	;
