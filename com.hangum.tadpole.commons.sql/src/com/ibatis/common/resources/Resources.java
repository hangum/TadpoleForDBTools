...
public class Resources extends Object {
  ...
  public static InputStream getResourceAsStream(ClassLoader loader, String resource) throws IOException {
    ...
    ClassLoader LocalLoader = SQLMap.class.getClassLoader();
    if (loader != null) in = LocalLoader.getResourceAsStream(resource);
    
    if (in == null) in = loader.getResourceAsStream(resource);
    if (in == null) in = ClassLoader.getSystemResourceAsStream(resource);
    if (in == null) throw new IOException("Custom tadpole Could not find resource " + resource);
    return in;
  }
