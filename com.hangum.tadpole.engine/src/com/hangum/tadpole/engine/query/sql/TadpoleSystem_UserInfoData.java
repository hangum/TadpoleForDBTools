...
//	private static final Logger logger = Logger.getLogger(TadpoleSystem_UserInfoData.class);
	 ...
	 * @throws SQLException
	 */
	public static UserInfoDataDAO updateAdminValueEncrypt(String key, String value) throws TadpoleSQLManagerException, SQLException {
		SqlMapClient sqlClient = TadpoleSQLManager.getInstance(TadpoleEngineUserDB.getUserDB());
		
		try { value = CipherManager.getInstance().encryption(value); } catch(Exception e) {}
