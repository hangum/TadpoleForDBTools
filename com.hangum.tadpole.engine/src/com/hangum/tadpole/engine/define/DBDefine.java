...
//	AMAZONRDS_DEFAULT
	...
	public String getLocation() {
		switch ( this ) {
			...
			case ELASTICSEARCH_DEFAULT: return prefix + "ElasticsearchConfig.xml";
			default:
...
//		else if(type.equalsIgnoreCase("AmazonRDS")) 	return AMAZONRDS_DEFAULT;
		...
		else if(type.equalsIgnoreCase("Elasticsearch"))       return DBDefine.ELASTICSEARCH_DEFAULT;
		else return null;
	}
	...
	public String getDriverClass() {
		switch ( this ) {
			...
			case MSSQL_DEFAULT:		
			case MSSQL_8_LE_DEFAULT: return "com.microsoft.sqlserver.jdbc.SQLServerDriver";
			...
			case ELASTICSEARCH_DEFAULT:	return "";
	...
	public String getDB_URL_INFO() {
		switch ( this ) {
			...
			case MSSQL_DEFAULT:		
			case MSSQL_8_LE_DEFAULT: return "jdbc:sqlserver://%s:%s;databaseName=%s";
			...
			case ELASTICSEARCH_DEFAULT: return "jdbc:elasticsearch://%s";
			default:
				return "undefine db";
		}
	}
...
//			case AMAZONRDS_DEFAULT: 	return "AmazonRDS";
			...
			case ELASTICSEARCH_DEFAULT:	return "Elasticsearch";
			default:
				return "undefine db";
		}
	}
	...
	public String[] getSystemVariableQuery() {
		...
		case ELASTICSEARCH_DEFAULT: return DBVariableDefine.ELASTICSEARCH_VARIABLE;
		default:
			return new String[]{};
		}
	}
