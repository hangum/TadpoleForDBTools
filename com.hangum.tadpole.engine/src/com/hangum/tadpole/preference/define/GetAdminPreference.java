...
public class GetAdminPreference extends AbstractPreference {
	...
	public static String getLDAPBaseDN() {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		return getAdminValue(mapUserInfoData, AdminPreferenceDefine.SYSTEM_LDAP_BASE_DN, AdminPreferenceDefine.SYSTEM_LDAP_BASE_DN_VALUE);
	}
	...
	public static String getLDAPBindDN() {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		return getAdminValue(mapUserInfoData, AdminPreferenceDefine.SYSTEM_LDAP_BINDDN, AdminPreferenceDefine.SYSTEM_LDAP_BINDDN_VALUE);
	}
	
	/**
	 * system LDAP bindDN pwd
	 * @return
	 */
	public static String getLDAPBindDNPwd() {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		String strValue = getAdminValue(mapUserInfoData, AdminPreferenceDefine.SYSTEM_LDAP_BINDDNPWD, AdminPreferenceDefine.SYSTEM_LDAP_BINDDNPWD_VALUE);

		try {
			strValue = CipherManager.getInstance().decryption(strValue);
		} catch(Exception e) {
			// ignore exception
		}
	 ...
	 * @return
	 */
	public static String getTadpoleSupportDBList() {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		return getAdminValue(mapUserInfoData, AdminPreferenceDefine.TADPOLE_SUPPORT_DB, AdminPreferenceDefine.TADPOLE_SUPPORT_DB_VALUE);
	}
	 ...
	 * @return
	 */
	public static String getIsDefaultOTP() {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		return getAdminValue(mapUserInfoData, AdminPreferenceDefine.IS_DEFAULT_OTP, AdminPreferenceDefine.IS_DEFAULT_OTP_VALUE);
	}
	 ...
	 * @param userInfoDao
	 */
	public static void updateAdminSessionData(UserInfoDataDAO userInfoDao) {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		mapUserInfoData.put(userInfoDao.getName(), userInfoDao);
	}
	
	/**
	 * update admin encryptData
	 * 
	 * @param userInfoDao
	 */
	public static void updateAdminSessionDataEncrypt(UserInfoDataDAO userInfoDao) {
		Map<String, UserInfoDataDAO> mapUserInfoData = TadpoleApplicationContextManager.getAdminSystemEnv();
		
//		try { userInfoDao.setValue0(CipherManager.getInstance().encryption(userInfoDao.getValue0())); } catch(Exception e) {}
//		try { userInfoDao.setValue1(CipherManager.getInstance().encryption(userInfoDao.getValue1())); } catch(Exception e) {}
//		try { userInfoDao.setValue2(CipherManager.getInstance().encryption(userInfoDao.getValue2())); } catch(Exception e) {}
//		try { userInfoDao.setValue3(CipherManager.getInstance().encryption(userInfoDao.getValue3())); } catch(Exception e) {}
//		try { userInfoDao.setValue4(CipherManager.getInstance().encryption(userInfoDao.getValue4())); } catch(Exception e) {}
//		try { userInfoDao.setValue5(CipherManager.getInstance().encryption(userInfoDao.getValue5())); } catch(Exception e) {}
