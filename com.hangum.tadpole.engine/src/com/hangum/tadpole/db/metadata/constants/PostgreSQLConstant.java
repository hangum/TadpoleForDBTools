...
/**
 * PostgreSQL Contstant
 * 
 * @author hangum
 *
 */
public class PostgreSQLConstant extends SQLConstants {

	public PostgreSQLConstant(UserDBDAO userDB) {
		super(userDB);
	}

	@Override
	public String keyword() {
		return "abort|absolute|abstime|access|aclitem|action|add|admin|after|aggregate|all|also|alter|always|" +
	...
	public String function() {
		return "RI_FKey_cascade_del|RI_FKey_cascade_upd|RI_FKey_check_ins|RI_FKey_check_upd|" +
	...
	public String constant() {
		return "True|False|None|NotImplemented|Ellipsis|__debug__";
	}

	@Override
	public String variable() {
		return "Array|Boolean|Date|Function|Iterator|Number|Object|RegExp|String|Proxy|"  + // Constructors
