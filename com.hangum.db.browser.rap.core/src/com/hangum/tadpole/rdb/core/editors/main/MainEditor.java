...
import com.hangum.tadpole.util.tables.SQLLibraryLabelProvider;
import com.hangum.tadpole.util.tables.SQLLibrarySorter;
...
public class MainEditor extends EditorPart {
	...
	/** tab index name */
	private enum RESULT_TAB_NAME {RESULT_SET, SQL_RECALL, SQL_LIBRARY, TADPOLE_MESSAGE};
...
//	    browserQueryEditor.setText("about:blank"); //$NON-NLS-1$
		...
		tabFolderResult.setData(RESULT_TAB_NAME.SQL_LIBRARY.toString(), 2);
		tabFolderResult.setData(RESULT_TAB_NAME.TADPOLE_MESSAGE.toString(), 3);
