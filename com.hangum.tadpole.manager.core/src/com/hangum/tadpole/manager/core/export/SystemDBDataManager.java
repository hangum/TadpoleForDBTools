 ...
 * 
 * SystemVersion OPERATION_TYPE, DBMS_TYPES, URL, DB, GROUP_NAME, DISPLAY_NAME,
 * HOST, PORT, LOCALE, PASSWD, USERS, IS_PROFILE, PROFILE_SELECT_MILL,
 * QUESTION_DML, IS_READONLYCONNECT, IS_AUTOCOMMIT, IS_SHOWTABLES, DELYN
 * 
 * @author hangum
 * 
 */
public class SystemDBDataManager {
	...
	public static String makeHead() {
		...
		retStr += "OPERATION_TYPE	, DBMS_TYPES	, URL					, DB			, GROUP_NAME	, 		" + "DISPLAY_NAME		, HOST			, PORT					, LOCALE		, PASSWD		, 		"
				+ "USERS			, IS_PROFILE	, PROFILE_SELECT_MILL	, QUESTION_DML	, IS_READONLYCONNECT, 	" + "IS_AUTOCOMMIT	, IS_SHOWTABLES	, DELYN ";
