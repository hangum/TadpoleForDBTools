...
/**
 * Admin DB Connection manager action
 * 
 * @author hangum
 *
 */
public class AdminTransactionConnectionManagerAction extends Action implements ISelectionListener, IWorkbenchAction {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(AdminTransactionConnectionManagerAction.class);
	private final static String ID = "com.hangum.db.browser.rap.core.actions.global.admin.TransactionDBConnectionManagerAction"; //$NON-NLS-1$
	
	private final IWorkbenchWindow window;
	
	public AdminTransactionConnectionManagerAction(IWorkbenchWindow window) {
		this.window = window;
