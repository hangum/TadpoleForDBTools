...
public class TadpoleConstraintComposite extends AbstractObjectComposite {
	...
	private void createWidget(final CTabFolder tabFolderObject) {
		...
		constraintTableViewer = new TableViewer(sashForm, /* SWT.VIRTUAL | */ SWT.BORDER | SWT.FULL_SELECTION);
	...
	private void createMenu() {
		...
		refreshAction_Constraint = new ObjectRefreshAction(getSite().getWorkbenchWindow(), PublicTadpoleDefine.OBJECT_TYPE.CONSTRAINTS, CommonMessages.get().Refresh);
