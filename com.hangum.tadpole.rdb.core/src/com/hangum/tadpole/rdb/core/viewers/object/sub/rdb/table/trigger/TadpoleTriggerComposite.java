...
public class TadpoleTriggerComposite extends AbstractObjectComposite {
	...
	private void createWidget(final CTabFolder tabFolderObject) {		
		...
		triggerTableViewer = new TableViewer(sashForm, /* SWT.VIRTUAL | */ SWT.BORDER | SWT.FULL_SELECTION);
	...
	private void createMenu() {
		...
		refreshAction_Trigger = new ObjectRefreshAction(getSite().getWorkbenchWindow(), PublicTadpoleDefine.OBJECT_TYPE.TRIGGERS, CommonMessages.get().Refresh);
