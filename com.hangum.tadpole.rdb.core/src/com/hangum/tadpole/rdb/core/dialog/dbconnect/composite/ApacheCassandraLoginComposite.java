...
/**
 * apache cassandra login composite
 * 
 * @author hangum
 *
 */
public class ApacheCassandraLoginComposite extends AbstractLoginComposite {
	private static final Logger logger = Logger.getLogger(ApacheCassandraLoginComposite.class);
...
//	protected Text textTadpoleHubURL;
...
//	protected Text textJDBCOptions;
	 ...
	 */
	public ApacheCassandraLoginComposite(Composite parent, int style, List<String> listGroupName, String selGroupName, UserDBDAO userDB, boolean isReadOnly) {
		super("Sample Apache Cssandra", DBDefine.APACHE_CASSANDRA_DEFAULT, parent, style, listGroupName, selGroupName, userDB, isReadOnly);
	}

	public ApacheCassandraLoginComposite(String strDisplayName, DBDefine selectDB,
	...
	public void crateComposite() {
		...
		lblNewLabelDatabase.setText("Keyspace");
...
//		
//		///manager server url ////////////////////////////////
//		Label lblTadpoleHubURL = new Label(grpConnectionType, SWT.NONE);
//		lblTadpoleHubURL.setText("TadpoleGW URL");
//		
//		textTadpoleHubURL = new Text(grpConnectionType, SWT.BORDER);
//		textTadpoleHubURL.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 4, 1));
		///manager server url ////////////////////////////////
...
//			textTadpoleHubURL.setText(StringUtils.trimToEmpty(oldUserDB.getMgnt_server_url()));
			...
			textUser.setText("cassandra"); //$NON-NLS-1$
			textPassword.setText("cassandra"); //$NON-NLS-1$
			textDatabase.setText("cycling"); //$NON-NLS-1$
			textPort.setText("9042");	 //$NON-NLS-1$
			
//			textJDBCOptions.setText("characterEncoding=utf8&connectTimeout=10000&zeroDateTimeBehavior=convertToNull&autoReconnect=true&reconnect=true"); //$NON-NLS-1$
		} else {
			textPort.setText("9042"); //$NON-NLS-1$
//			textJDBCOptions.setText("characterEncoding=utf8&connectTimeout=10000&zeroDateTimeBehavior=convertToNull&autoReconnect=true&reconnect=true"); //$NON-NLS-1$
		}
...
//		}
		...
		// mgnt server url
//		userDB.setMgnt_server_url(textTadpoleHubURL.getText());
