...
public class AlterTableConsts {
	...
	public static final int PRIMARY_KEY_IDX = 3;
	public static final int DATA_TYPE_IDX = 4;
	public static final int DATA_SIZE_IDX = 5;
	public static final int DATA_PRECISION_IDX = 6;
	public static final int DATA_SCALE_IDX = 7;
	public static final int DEFAULT_VALUE_IDX = 8;
	public static final int NULLABLE_IDX = 9;
	...
	public static final String[] names = {SEQ_NO,COLUMN_NAME,COLUMN_ID,PRIMARY_KEY,DATA_TYPE,DATA_SIZE,DATA_PRECISION,DATA_SCALE,DEFAULT_VALUE,NULLABLE};
	public static final int[] sizes = {SEQ_NO_SIZE,COLUMN_NAME_SIZE,COLUMN_ID_SIZE,PRIMARY_KEY_SIZE,DATA_TYPE_SIZE,DATA_SIZE_SIZE,DATA_PRECISION_SIZE,DATA_SCALE_SIZE,DEFAULT_VALUE_SIZE,NULLABLE_SIZE};
}
