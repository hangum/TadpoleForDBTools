...
//	public static final int COLUMN_ID_IDX = 2;
	public static final int PRIMARY_KEY_IDX = 2;
	public static final int DATA_TYPE_IDX = 3;
	public static final int DATA_SIZE_IDX = 4;
	public static final int DATA_PRECISION_IDX = 5;
	public static final int DATA_SCALE_IDX = 6;
	public static final int DEFAULT_VALUE_IDX = 7;
	public static final int NULLABLE_IDX = 8;
