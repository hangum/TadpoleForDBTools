...
public class HiveLoginComposite extends AbstractLoginComposite {
	...
	// Logger.getLogger(HiveLoginComposite.class);
	...
	public HiveLoginComposite(String strDisplayName, DBDefine selectDB, Composite parent, int style, List<String> listGroupName, String selGroupName,
			UserDBDAO userDB) {
	...
	public boolean isValidateInput() {
		if (!checkTextCtl(preDBInfo.getComboGroup(), "Group"))
			return false;
