 ...
 *
 */
public class OthersConnectionElasticsearchGroup extends AbstractOthersConnection {
	/**
	 * Logger for this class
	 */
	private static final Logger logger = Logger.getLogger(OthersConnectionElasticsearchGroup.class);
...
//	private Button btnSendMonitoring;
	 ...
	 * @param strPort
	 */
	public OthersConnectionElasticsearchGroup(Composite parent, int style, DBDefine selectDB) {
		...
		btnReadOnlyConnection.setSelection(true);
