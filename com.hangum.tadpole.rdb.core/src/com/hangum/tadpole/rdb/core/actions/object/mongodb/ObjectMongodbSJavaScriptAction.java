...
//				ExceptionDetailsErrorDialog.openError(null,CommonMessages.get().Error, "JavaScript Open Exception", errStatus); //$NON-NLS-1$
//			}
//
//		} catch (Exception e) {
...
//
//			Status errStatus = new Status(IStatus.ERROR, Activator.PLUGIN_ID, e.getMessage(), e); //$NON-NLS-1$
//			ExceptionDetailsErrorDialog.openError(null,CommonMessages.get().Error, e.getMessage(), errStatus); //$NON-NLS-1$
//		}
//	}
//	
//}
