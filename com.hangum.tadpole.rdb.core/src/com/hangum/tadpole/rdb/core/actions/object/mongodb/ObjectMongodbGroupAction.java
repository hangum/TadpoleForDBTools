...
public class ObjectMongodbGroupAction extends AbstractObjectAction {
	...
	public ObjectMongodbGroupAction(IWorkbenchWindow window, PublicTadpoleDefine.OBJECT_TYPE actionType, String title) {
	...
	public void run(IStructuredSelection selection, UserDBDAO userDB, OBJECT_TYPE actionType) {
		...
		try {
			...
			ExceptionDetailsErrorDialog.openError(null,CommonMessages.get().Error, "Group Open Exception", errStatus); //$NON-NLS-1$
		}
	}
