 ...
 *
 */
public class CreateSequenceAction extends AbstractQueryAction {
	...
	public void run(IAction action) {
		...
		FindEditorAndWriteQueryUtil.run(userDB, 
				QueryTemplateUtils.getQuery(userDB, PublicTadpoleDefine.OBJECT_TYPE.SEQUENCE), 
				PublicTadpoleDefine.OBJECT_TYPE.SEQUENCE);
	}
