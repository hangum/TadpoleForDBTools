...
//		}
	 ...
	 */
	public void showResultView(final RequestQuery reqQuery, final List<QueryExecuteResultDTO> listRSDao, List<Long> listLongHistorySeq) {
		compositeResultSet.showResultView(reqQuery, listRSDao, listLongHistorySeq);
	}
