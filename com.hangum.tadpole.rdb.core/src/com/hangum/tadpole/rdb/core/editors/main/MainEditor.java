...
public class MainEditor extends EditorExtension {
	...
	protected String strLastContent = "";
	
	/** toolbar auto commit */
	protected ToolItem tiAutoCommit = null, tiAutoCommitCommit = null, tiAutoCommitRollback = null, tltmTextResultView = null;
	protected PublicTadpoleDefine.RESULT_COMP_TYPE resultViewType = RESULT_COMP_TYPE.Table;
