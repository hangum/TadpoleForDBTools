 ...
 * <ul>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getSource <em>Source</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getSource_kind <em>Source kind</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getTarget_kind <em>Target kind</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getColumn_name <em>Column name</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getReferenced_column_name <em>Referenced column name</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getBendpoint <em>Bendpoint</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getDb <em>Db</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.RelationImpl#getConstraint_name <em>Constraint name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RelationImpl extends EObjectImpl implements Relation {
	...
	protected EClass eStaticClass() {
		return TadpolePackage.Literals.RELATION;
	}
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TadpolePackage.RELATION__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(Table newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__SOURCE, oldSource, newSource);
	...
	public void setSource(Table newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject)source).eInverseRemove(this, TadpolePackage.TABLE__OUTGOING_LINKS, Table.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject)newSource).eInverseAdd(this, TadpolePackage.TABLE__OUTGOING_LINKS, Table.class, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__SOURCE, newSource, newSource));
	}
	...
	public Table getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TadpolePackage.RELATION__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(Table newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(Table newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject)target).eInverseRemove(this, TadpolePackage.TABLE__INCOMING_LINKS, Table.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject)newTarget).eInverseAdd(this, TadpolePackage.TABLE__INCOMING_LINKS, Table.class, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__TARGET, newTarget, newTarget));
	}
	...
	public void setSource_kind(RelationKind newSource_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__SOURCE_KIND, oldSource_kind, source_kind));
	}
	...
	public void setTarget_kind(RelationKind newTarget_kind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__TARGET_KIND, oldTarget_kind, target_kind));
	}
	...
	public EList<Point> getBendpoint() {
		if (bendpoint == null) {
			bendpoint = new EDataTypeUniqueEList<Point>(Point.class, this, TadpolePackage.RELATION__BENDPOINT);
		}
		return bendpoint;
	}
	...
	public void setConstraint_name(String newConstraint_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__CONSTRAINT_NAME, oldConstraint_name, constraint_name));
	}
	 ...
	 */
	public DB getDb() {
		if (eContainerFeatureID() != TadpolePackage.RELATION__DB) return null;
	...
	public NotificationChain basicSetDb(DB newDb, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newDb, TadpolePackage.RELATION__DB, msgs);
		return msgs;
	}
	...
	public void setDb(DB newDb) {
		if (newDb != eInternalContainer() || (eContainerFeatureID() != TadpolePackage.RELATION__DB && newDb != null)) {
			...
			if (newDb != null)
				msgs = ((InternalEObject)newDb).eInverseAdd(this, TadpolePackage.DB__REFERENCES, DB.class, msgs);
			msgs = basicSetDb(newDb, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__DB, newDb, newDb));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__COMMENT, oldComment, comment));
	}
	...
	public void setColumn_name(String newColumn_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__COLUMN_NAME, oldColumn_name, column_name));
	}
	...
	public void setReferenced_column_name(String newReferenced_column_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.RELATION__REFERENCED_COLUMN_NAME, oldReferenced_column_name, referenced_column_name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TadpolePackage.RELATION__SOURCE:
				if (source != null)
					msgs = ((InternalEObject)source).eInverseRemove(this, TadpolePackage.TABLE__OUTGOING_LINKS, Table.class, msgs);
				return basicSetSource((Table)otherEnd, msgs);
			case TadpolePackage.RELATION__TARGET:
				if (target != null)
					msgs = ((InternalEObject)target).eInverseRemove(this, TadpolePackage.TABLE__INCOMING_LINKS, Table.class, msgs);
				return basicSetTarget((Table)otherEnd, msgs);
			case TadpolePackage.RELATION__DB:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TadpolePackage.RELATION__DB:
				return eInternalContainer().eInverseRemove(this, TadpolePackage.DB__REFERENCES, DB.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TadpolePackage.RELATION__SOURCE_KIND:
				return getSource_kind();
			case TadpolePackage.RELATION__TARGET_KIND:
				return getTarget_kind();
			case TadpolePackage.RELATION__COLUMN_NAME:
				return getColumn_name();
			case TadpolePackage.RELATION__REFERENCED_COLUMN_NAME:
				return getReferenced_column_name();
			case TadpolePackage.RELATION__BENDPOINT:
				return getBendpoint();
			case TadpolePackage.RELATION__DB:
				return getDb();
			case TadpolePackage.RELATION__COMMENT:
				return getComment();
			case TadpolePackage.RELATION__CONSTRAINT_NAME:
