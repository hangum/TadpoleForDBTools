 ...
 * <ul>
 *   <li>{@link com.hangum.tadpole.model.impl.ViewImpl#getTableName <em>Table Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ViewImpl extends TableImpl implements View {
	...
	protected EClass eStaticClass() {
		return TadpolePackage.Literals.VIEW;
	}
		...
		if (tableName != null && tableName.eIsProxy()) {
			...
			if (tableName != oldTableName) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TadpolePackage.VIEW__TABLE_NAME, oldTableName, tableName));
			}
		}
		return tableName;
	}
	...
	public void setTableName(Table newTableName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.VIEW__TABLE_NAME, oldTableName, tableName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TadpolePackage.VIEW__TABLE_NAME:
