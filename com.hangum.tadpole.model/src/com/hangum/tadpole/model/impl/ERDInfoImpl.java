 ...
 * <ul>
 *   <li>{@link com.hangum.tadpole.model.impl.ERDInfoImpl#isAutoLayout <em>Auto Layout</em>}</li>
 *   <li>{@link com.hangum.tadpole.model.impl.ERDInfoImpl#getVersion <em>Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ERDInfoImpl extends EObjectImpl implements ERDInfo {
	...
	protected EClass eStaticClass() {
		return TadpolePackage.Literals.ERD_INFO;
	}
	...
	public void setAutoLayout(boolean newAutoLayout) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.ERD_INFO__AUTO_LAYOUT, oldAutoLayout, autoLayout));
	}
	...
	public void setVersion(String newVersion) {
		...
		version = newVersion;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TadpolePackage.ERD_INFO__VERSION, oldVersion, version));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TadpolePackage.ERD_INFO__AUTO_LAYOUT:
				return isAutoLayout();
			case TadpolePackage.ERD_INFO__VERSION:
				return getVersion();
		}
